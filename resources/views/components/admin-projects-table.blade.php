            ...
            <tr>
                ...
                <td class="d-flex">
                    ...
                    <button type="button" class="btn btn-danger me-2" data-bs-toggle="modal"
                        data-bs-target="#confirmDeleteProject-{{$project->id}}" data-bs-placement="bottom"
                        title="Delete">
                        <i class="fa-solid fa-trash-can text-white"></i>
                    </button>
                    <!-- Modal -->
                    <div class="modal fade" id="confirmDeleteProject-{{$project->id}}" data-bs-backdrop="static"
                        data-bs-keyboard="false" tabindex="-1"
                        aria-labelledby="confirmDeleteProjectLabel-{{$project->id}}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="confirmDeleteProjectLabel-{{$project->id}}">Click
                                        on
